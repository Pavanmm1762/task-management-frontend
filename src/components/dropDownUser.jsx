...
const DropdownUser = () => {
    ...
    return (
        <div className="relative">
            <div
                ref={trigger}
                className="flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-xl"
            ...
            <div
                ...
                className={`absolute right-0 mt-4 flex w-64 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-cyan-700 dark:bg-secondary-dark-bg ${dropdownOpen === true ? 'block' : 'hidden'
                    }`}
            >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7 dark:border-cyan-700">
                    <li>
                        <Link
                            to="/"
                            className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-blue-600 lg:text-base dark:text-gray-400 dark:hover:text-blue-600 "
                        >
                            <svg
                    ...
                    <li>
                        <Link
                            to="#"
                            className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-blue-600 dark:hover:text-blue-600 lg:text-base dark:text-gray-400"
                        >
                            <svg
                                className="fill-current"
                                width="22"
                ...
                <button
                    ...
                    className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-blue-600 lg:text-base dark:text-gray-400 dark:hover:text-blue-600 ">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
