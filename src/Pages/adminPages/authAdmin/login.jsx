    ...
    <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      ...
      <div className="md:w-1/3 max-w-sm">
        <div className="text-center md:text-left">
          <label className="mr-1 text-2xl dark:text-white capitalize">Admin login</label>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mt-2 font-semibold text-sm text-slate-500 text-center md:text-left">
            Are you a member?
            <Link className="text-blue-600 hover:underline hover:underline-offset-4" to="/member/login"> Go to Member Login</Link>
          </div>
        </form>
      </div>
    </section>
